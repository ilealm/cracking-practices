...
def test_rotate_matix_90_new_matrix_one(matrix_3by3):
    expected = [
        [7, 4, 1],
        [8, 5, 2],
        [9, 6, 3],
...
def test_rotate_matix_90_new_matrix_two(matrix_2by2):
    expected = [
        [3, 1],
        [4, 2]
    ]
...
def test_rotate_matix_90_new_matrix_three(matrix_4by4):
    expected = [
        [13, 9, 5, 1],
        [14, 10, 6, 2],
        [15, 11, 7, 3],
